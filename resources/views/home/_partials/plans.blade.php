                        ...
                        <div class="card card--col" :id="item.ref" id="Pro">
                            <div class="card__header">
                                ...
                                <div class="card__price">
                                    <span class="price-currency mr-2">R$</span>
                            ...
                            <div class="card__features">
                                <template x-for="(feature, index) in item.features" :key="index">
                                    <p class="feature">
                            ...
                            <div class="card__footer text-center my-4">
                                <a href="{{ route('choice.plan', $plan->url) }}" class="button button--filled button--primary">Assinar Agora Mesmo<svg
